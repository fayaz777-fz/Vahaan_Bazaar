...
import { Search, Menu, X, Star, ChevronRight, Heart, Home as HomeIcon, Bike, Settings, User, GitCompare, Shield, CheckCircle, Calculator, CreditCard, Wallet, Building2, MessageCircle, Phone, Mail } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
                        ...
                        <button
                          ...
                          onClick={() => {
                            if (item.name === 'Profile') {
                              ...
                              navigate('/contact');
                            } else if (item.name === 'Sell Bikes') {
                              // Navigate to sell bikes page
                              console.log('Navigating to sell bikes');
                              navigate('/sell-bikes');
                            } else if (item.name === 'Sell Scooters') {
                              // Navigate to sell scooters page
                              console.log('Navigating to sell scooters');
                              navigate('/sell-scooters');
      ...
      <main className="lg:ml-0 pt-4 pb-6 flex-grow">
        ...
        <motion.section
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 1.0, duration: 0.8 }}
          className="bg-gradient-to-r from-indigo-600 via-blue-600 to-purple-700 rounded-2xl shadow-2xl p-8 mb-12 text-white"
        >
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold mb-4">Get in Touch with Us</h2>
            <p className="text-lg text-blue-100 max-w-2xl mx-auto">
              Have questions about buying or selling vehicles? Our expert team is here to help you every step of the way.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            >
              ...
              <a 
                ...
                className="bg-white text-indigo-600 px-6 py-2 rounded-lg font-medium hover:bg-blue-50 transition-colors"
              >
                +91 98765 43210
              </a>
            </motion.div>
            ...
            >
              ...
              <p className="text-blue-100 mb-4">Get detailed assistance via email</p>
              <a 
                href="mailto:support@vahaanbazaar.com" 
                className="bg-white text-indigo-600 px-6 py-2 rounded-lg font-medium hover:bg-blue-50 transition-colors"
              >
                Send Email
              </a>
            ...
            >
              ...
              <p className="text-blue-100 mb-4">Fill out our detailed contact form</p>
              <button 
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
            ...
            <div>
              ...
              <div className="text-blue-100 text-sm">Vehicles Sold</div>
            </div>
            <div>
