...
import { ArrowLeft, Upload, Zap, Calendar, Gauge, DollarSign, FileText, Fuel } from 'lucide-react';
import apiService from '../services/api';

interface SellScooterFormProps {
  onBack: () => void;
  onSubmit?: (formData: ScooterFormData) => void;
}
...
interface ScooterSubmissionData {
  name: string;
  brand: string;
  daysUsed: number;
  condition: 'Excellent' | 'Good' | 'Fair' | 'Poor';
...
export default function SellScooterForm({ onBack, onSubmit }: SellScooterFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const submissionData: ScooterSubmissionData = {
        name: formData.name,
      ...
      const response = await apiService.createScooterListing(submissionData as any);
      ...
      if (onSubmit) {
        ...
        alert('Your scooter has been listed successfully!');
        setTimeout(() => {
          onBack();
        }, 2000);
      }
    } catch (error: any) {
      console.error('Error submitting scooter listing:', error);
      setSubmitError(error.message || 'Failed to submit scooter listing. Please try again.');
    } finally {
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-4 h-16">
            ...
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-xl font-bold text-gray-900">Sell Your Scooter</h1>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-xl shadow-lg p-8">
          <div className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-2">List Your Scooter for Sale</h2>
            <p className="text-gray-600">Fill in the details below to create your scooter listing</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div>
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-gray-400 transition-colors">
                ...
                <p className="text-sm text-gray-500">Upload up to 10 photos of your scooter</p>
              </div>
              {images.length > 0 && (
            ...
            {submitSuccess && (
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                <p className="text-green-800">Your scooter has been listed successfully!</p>
              </div>
            )}
